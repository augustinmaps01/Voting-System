            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="voters_add.php" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="student" name="student_id" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="edit_course" class="col-sm-3 control-label">Course&Year</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="voters_edit.php">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <label for="edit_student" class="col-sm-3 control-label">Student ID</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="edit_student" name="student">
                            </div>
                        </div>
...
<div class="modal fade" id="import" role="dialog">
                    <div class="modal-dialog modal-md">
                        ...
                        <form name="frmCSVImport" id="frmCSVImport"  enctype="multipart/form-data" class="form-horizontal" action="" method="post" enctype="multipart/form-data" id="importFrm">
                            <div class="modal-body">
                                <div class="form-group ">
                                <div class = "col-sm-4">
