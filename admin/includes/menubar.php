  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
         ...
         <li class=""><a href="voted.php"><span class="glyphicon glyphicon-check"></span> <span>Voted</span></a></li>
     <li class="header">MANAGE</li>
      ...
      <li class=""><a href="partylist.php"><i class="fa fa-group"></i> <span>Partylist</span></a></li>
